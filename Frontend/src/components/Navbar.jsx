...
return ()=>{
  ...
  return (
    <>
    <div className={`max-w-screen-2xl conatiner mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 right-0 left-0 z-50 ${sticky?"sticky-navbar shadow-md bg-base-200 dark:text-white duration-300 transition-all ease-in-out":""}`}>
  ...
  <label className="bordered flex items-center gap-2">
  <input type="text" className="grow outline-none text-1xl dark:bg-slate-900 dark:text-white" placeholder="Search" />
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" 
  
  fill="currentColor" className="w-4 h-4 opacity-70"><path fillRule="evenodd" d="M9.965 11.026a5 5 0 1 1 1.06-1.06l2.755 2.754a.75.75 0 1 1-1.06 1.06l-2.755-2.754ZM10.5 7a3.5 3.5 0 1 1-7 0 3.5 3.5 0 0 1 7 0Z" clipRule="evenodd" /></svg>
</label> 
</div>
...
{/* { 
 authUser? (<Logout/>):(
    <div className="">
     <a className="bg-black text-white p-2 rounded-md hover:bg-slate-500 duration-300 cursor-pointer text-1xl" onClick={()=>
